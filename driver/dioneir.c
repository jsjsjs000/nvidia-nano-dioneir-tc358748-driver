...
#include "dioneir_tc358748_i2c.h"
...
dev_info(tc_dev->dev, "--------- set_mode 2\n");
return tc358748_setup(ctl_regmap, priv->tx_regmap) ? 0 : -1; // $$
...
// dev_info(tc_dev->dev, "--------- set_mode ok\n");
...
dev_info(tc_dev->dev, "--------- start streaming\n");
...
dev_info(tc_dev->dev, "--------- stop streaming\n");
